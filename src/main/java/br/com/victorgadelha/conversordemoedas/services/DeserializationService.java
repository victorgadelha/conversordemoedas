...
public class DeserializationService {
     ...
     * System.out.println(currencyName + currency.getCurrencyValue());
     * 
     * return currency;
     * }
     */
...
// switch (currencyName) {
// ase "USD":
// for (Map.Entry<String, Double> currencyValue :
// currency.getExchangeRates().entrySet()) {
// if (currencyValue.getKey() == "ARS") {
// currency.setCurrencyValue(currencyValue.getValue());

// System.out.println("Chave: " + currencyValue.getKey() + ", Valor: " +
